...
import com.codepath.travelbud.UserSearchAdapterCopy;
...
public class SearchCopyFragment extends Fragment {

    public static final String TAG = "SearchFragment";

    private String KEY_USERNAME = "username";
    private RecyclerView rvUsersSearch;
    private UserSearchAdapterCopy adapter;
...
//        adapter = new UserSearchAdapter(getContext(), allUsers);
        adapter = new UserSearchAdapterCopy(getContext(), searchUsers, communication);
